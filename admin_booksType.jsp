			...
			<div class="content">
				<div class="left">
					...
					<div class="gongGao">
                        ...
                        <div class="context">
                            <a href="https://news.cdut.edu.cn/dcxy.htm">》多彩校园</a>
                            <a href="https://news.cdut.edu.cn/xsjl.htm">》学术交流</a>
                            <a href="https://news.cdut.edu.cn/clyw.htm">》成理要闻</a>
                            <a href="https://news.cdut.edu.cn/jxky.htm">》教学科研</a>
                        </div>
                    </div>
                    <div class="gongGao" style="height:400px;">
                        <div class="title">馆内公约</div>
                        <div class="context">
                            <div style="font-size:14px; width: 100%;  height: 400px;margin-bottom: 20px;">
                                <div style="padding: 5px;  color: black">
                                    <label style="font-size:15px;font-weight: normal;">1.保持安静，不大声喧哗、不使用有声通讯工具</label><br />
                                    <label style="font-size:15px;font-weight: normal;">2.讲究卫生，不乱扔废弃物</label><br />
                                    <label style="font-size:15px;font-weight: normal;">3.衣着整洁，不穿拖鞋入馆</label><br />
                                    <label style="font-size:15px;font-weight: normal;">4.保持文明礼貌，不抢占座位</label><br />
                                    <label style="font-size:15px;font-weight: normal;">5.爱护公物，不污损公共设施、不毁坏书刊资料</label>
			</div>
